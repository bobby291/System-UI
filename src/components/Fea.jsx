...
import backgroundimage from '../assets/features-hero-bg.jpg'
import AOS from 'aos';
  ...
  return (
    ...
    lg:pb-[80px] pb-[60px] lg:gap-[60px] gap-[40px] bg-cover bg-center' style={{
      ...
      <div className='lg:w-1/2 w-full flex flex-col gap-[20px] items-start justify-center'>
        ...
        leading-[1.2em] font-poppins'>Build. Develop. Automate with AI</h1>
        <p data-aos="zoom-in" data-aos-delay="170" className='text-gray-300 text-md font-poppins'>Ehancing the tech space with the transformation of AI
          and Building to Develop into AI for fast growing and security to keep scalability and enhancement
        </p>
