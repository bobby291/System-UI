...
import backgroundimage from '../assets/resou-bg.jpg'
import AOS from 'aos';
  ...
  return (
    ...
    lg:pb-[80px] pb-[60px] lg:gap-[60px] gap-[40px] bg-cover bg-center' style={{
      ...
      <div className='lg:w-1/2 w-full flex flex-col gap-[20px] items-start justify-center'>
        ...
        leading-[1.2em] font-poppins'>Exploring the Tech Cycle and Angles</h1>
        <p data-aos="zoom-in" data-aos-delay="170" className='text-gray-300 text-md font-poppins'>Cutting and shapping the future with 
          Airtificial Intelligences and to provides scalable solutions, From Development to Automation which result to cutting cost and 
          saving time which makes cyclax a goal
        </p>
      ...
      <div className='lg:w-1/2 w-full flex justify-center items-center'>
        <div data-aos="zoom-in" data-aos-delay="230" className='lg:w-[80%] w-full flex justify-center items-center px-5 pt-5 bg-purple-600 bg-opacity-30 z-10 rounded-md'>
